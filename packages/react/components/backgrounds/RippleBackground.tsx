...
import type { RippleBackgroundProps } from "../../motion-types";
 ...
 */
export const RippleBackground = forwardRef<HTMLDivElement, RippleBackgroundProps>(
  function RippleBackground({
    ...
    const rippleColor = color ?? "var(--infini-color-primary)";
