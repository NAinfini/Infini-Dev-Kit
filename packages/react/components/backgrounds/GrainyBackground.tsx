...
import type { GrainyBackgroundProps } from "../../motion-types";
 ...
 */
export const GrainyBackground = forwardRef<HTMLDivElement, GrainyBackgroundProps>(
  function GrainyBackground({
    ...
    const primaryColor = color ?? "var(--infini-color-primary)";
    const secondaryColor = colorSecondary ?? "var(--infini-color-accent)";
