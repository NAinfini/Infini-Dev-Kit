...
import type { SelectStepperItem, SelectStepperProps } from "../../motion-types";
      ...
      >
        ...
        <div
          style={{
            ...
            overflow: "hidden",
            position: "relative",
            borderTop: "var(--infini-border-width) var(--infini-border-style, solid) var(--infini-color-border)",
            ...
            {items.map((item, idx) => (
              <div
                ...
                style={{
                  ...
                  fontSize: 13,
                  fontWeight: idx === currentIndex ? "var(--infini-font-display-weight, 700)" as CSSProperties["fontWeight"] : 400,
                  color: idx === currentIndex ? "var(--infini-color-text)" : "var(--infini-color-text-muted)",
                  userSelect: "none",
                }}
              >
