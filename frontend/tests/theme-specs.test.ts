...
import { getThemeSpec, listThemeIds, listThemeSpecs } from "../theme/theme-specs";
...
describe("theme specs", () => {
  ...
  it("matches red-gold reference details", () => {
    ...
    expect(redGold.palette.accent).toBe("#CC2222");
  ...
  it("provides i18n typography and advanced motion fields", () => {
    ...
    expect(cyberpunk.typography.zh.body).toContain("Noto Sans SC");
